...
abstract class AbstractObjectNormalizer extends AbstractNormalizer
{
    ...
    private function getAttributeMetadata(object|class $objectOrClass, string $attribute): ?AttributeMetadataInterface
    {
     ...
     * {@inheritdoc}
     */
    public function denormalize(array|string|int|float|bool $data, string $type, string $format = null, array $context = [])
    {
        if (!isset($context['cache_key'])) {
            $context['cache_key'] = $this->getCacheKey($format, $context);
        }
     ...
     */
    private function validateAndDenormalize(string $currentClass, string $attribute, mixed $data, ?string $format, array $context): mixed
    {
