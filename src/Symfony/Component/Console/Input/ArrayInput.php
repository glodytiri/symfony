...
class ArrayInput extends Input
{
     ...
     */
    private function addShortOption(string $shortcut, ?string $value)
    {
     ...
     */
    private function addLongOption(string $name, ?string $value)
    {
     ...
     */
    private function addArgument(string|int $name, $value)
    {
